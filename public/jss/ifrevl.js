...
function updateCalendarLinks() {
  ...
  if (credEtDiv) {
    ...
    const mainBlockHtml = `
<div>
<hr> || <a href="javascript:void(0);" class="events-modal-trigger"><b>VIEW ALL EVENTS</b></a> || <a href="#" class="cal-link-ics tooltip"><b>📅 DOWNLOAD ALL EVENTS</b><span class="tooltip-text">Download all upcoming events as an .ics file that you can import into your calendar app (Google Calendar, Apple Calendar, Outlook, etc.)</span></a> ||<hr>
